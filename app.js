...
var budgetController = (function() {
    ...
    Expense.prototype.calcPercentage = function(totalIncome) {
        if (totalIncome > 0) {
            this.pecentage = Math.round((this.value / totalIncome) * 100);
        } else {
            this.pecentage = -1;
        }
    };
    ...
    return {
        addItem: function(type, des, val) {
            ...
            // Create new item bysed on 'inc' or 'exp' type
            if(type === 'exp') {
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        num = Math.abs(num);
        num = num.toFixed(2); // get string -> "50.00"

        numSplit = num.split('.'); // get arr ['50', '0']

        int = numSplit[0];
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3 , 3); // input 23510 -> 23,510
            // 600 000 -> 600,000; 1 000 000 -> 1000,000
        }
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            // Insert the HTML into the DOM // element.insertAdjacentHTML(position, text);
